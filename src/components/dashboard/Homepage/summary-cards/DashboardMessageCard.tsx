...
const DashboardMessageCard = () => {
  return (
    <div className="cursor-pointer bg-secondary shadow-md rounded-md w-full h-48 hover:bg-primary/20 hover:scale-105 transition duration-700 flex justify-center items-center group">
